...
from ..serdes                     import RxDatapath, TxDatapath
...
class GTP(Elaboratable):
    ...
    def elaborate(self, platorm):
        ...
        tx_gpio         = Signal()
        m.submodules += [
            FFSynchronizer(self.use_tx_gpio, use_tx_gpio, o_domain="tx"),
...
class LunaArtix7SerDes(Elaboratable):
    ...
    def elaborate(self, platform):
        ...
        m.d.comb += [
            ...
            serdes.use_tx_gpio            .eq(self.use_tx_as_gpio),
            serdes.tx_gpio                .eq(self.tx_gpio),

            self.rx_gpio                  .eq(~serdes.rx_idle),
